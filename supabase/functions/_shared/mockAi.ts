...
// Deterministic AdCopyOrchestrator output (envelope + payload) for offline/dev
// runs without ANTHROPIC_API_KEY. Bilingual, judge advisory + uncalibrated.
export function mockAdCopy(): Record<string, unknown> {
  return {
