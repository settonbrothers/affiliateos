// Node-side ComplianceCheckOrchestrator contract. See decisions/003 — KEEP IN
// SYNC with supabase/functions/_shared/types/compliance.ts. Mirrors
// docs/plan/05_AGENT_ROSTER.md §ComplianceCheckOrchestrator.
import { z } from 'zod'
