      ...
      >
        ...
        <div className="mt-5 grid gap-4 border border-amber-300/35 bg-amber-300/[0.07] p-5 text-amber-50 md:grid-cols-[190px_1fr] md:items-start xl:p-6">
          <div>
            ...
            <div className="mt-2 text-xl font-semibold">נעצר בשער הזווית</div>
          </div>
          <p className="text-base leading-8 text-amber-50/85">
            ריצת v3.6 הסתיימה ללא מועמד להצגה. הזווית הראשית וסבב התיקון היחיד
            ניסו לייחס לכלי AI כלליים היעדר יכולת שלא הוכחה במקורות. השער עצר
            את המסלול לפני מנהל הקופי, ההוקים והכתיבה. כל 26 הלקחים פעילים,
            הגרסה אינה פעילה במערכת ושמונת המבחנים לא התחילו.
          </p>
        </div>
